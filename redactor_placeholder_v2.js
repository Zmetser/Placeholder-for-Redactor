...
RedactorPlugins.placeholders = {
    ...
    init: function () {
        ...
        this.placeholders = this.$element.data('placeholders');

        var placeholders = this.fetchPlaceholders();

        this.buttonAdd('placeholders', 'Insert Placeholder', false, placeholders);
        this.buttonAddSeparatorBefore('placeholders');
    ...
    initKeyMap: function () {
        ...
        this.opts.keydownCallback = $.proxy(function ( event ) {
            ...
            // Backspace polyfill
            if ( event.keyCode == 8 && !this.getSelectionHtml().length )
    ...
    _backspacePolyfill: function ( event ) {
        ...
        this.insertNode(this._removeHelperElement);
    ...
    addPlaceholder: function ( placeholder, event ) {
        ...
        this.bufferSet(); // Set buffer for redo
    ...
    replacePlaceholdersWithHTML: function () {
        ...
        console.log('replacePlaceholdersWithHTML')
    ...
    getTransformedHtml: function () {
        var $html = jQuery('<div>' + this.get() + '</div>');
